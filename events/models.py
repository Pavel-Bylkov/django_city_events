...
class City(models.Model):
    ...
    country = models.ForeignKey(Country, null=True, blank=False,
                                on_delete=models.SET_NULL, related_name='cities')
...
class EventFilters(models.Model):
    user = models.ForeignKey(User, blank=False, related_name='filters')
    city = models.ForeignKey(City, null=False, blank=True, on_delete=models.SET_NULL)
    topics = models.ManyToManyField(Topics, null=False, blank=True)
