"""
Django settings for django_city_events project.
...
ROOT_URLCONF = 'django_city_events.urls'
...
WSGI_APPLICATION = 'django_city_events.wsgi.application'
